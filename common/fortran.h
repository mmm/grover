...
struct Fortran_doublecomplex {
    double r,i;
    Fortran_doublecomplex() {};
    Fortran_doublecomplex(int) {};
};

typedef Fortran_doublecomplex *fza_;        // (in/out) double precision array
typedef const Fortran_doublecomplex *cfza_; // (in) double precsion array

typedef Fortran_complex *fca_;        // (in/out) double precision array
typedef const Fortran_complex *cfca_; // (in) double precsion array
